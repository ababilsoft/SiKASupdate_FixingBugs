...
public class exportPemasukanPDF {
    ...
    public static void createPdf(@NonNull Context mContext, List<MCatatanKeuanganMasuk> dataList, @NonNull String fileName, boolean isPortrait) throws Exception {
    ...
    public static void addHeader(Context mContext, Document document, List<MCatatanKeuanganMasuk> dataList) throws Exception {
    ...
    static String countTotalPemasukan(List<MCatatanKeuanganMasuk> dataList) {
        int totalPemasukan = 0;
        for (MCatatanKeuanganMasuk semua : dataList) {
    ...
    public static PdfPTable createDataTable(List<MCatatanKeuanganMasuk> dataList) throws DocumentException {
        ...
        for (int i = 0; i < size; i++) {
            MCatatanKeuanganMasuk semua = dataList.get(i);
            ...
            cell = new PdfPCell(new Phrase(semua.getTujuanFinansial(), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(7f);
            table1.addCell(cell);
