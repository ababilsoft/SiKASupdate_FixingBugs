...
public final class exportRiwayatHutangPDF {
    ...
    public static void createPdf(@NonNull Context mContext, List<MUtangPiutang> dataList, @NonNull String fileName, boolean isPortrait) throws Exception {
    ...
    public static void addHeader(Context mContext, Document document, List<MUtangPiutang> dataList) throws Exception {
...

        {
            ...
            Paragraph temp = new Paragraph("Utang Saya", FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph("Rp. " + countTotalUtangSaya(dataList), FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph("Utang Teman", FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph("Rp. " + countTotalUtangTeman(dataList), FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }
    ...
    static String countTotalUtangSaya(List<MUtangPiutang> dataList) {
        int totalPemasukan = 0;
        for (MUtangPiutang hutang : dataList) {
            if (hutang.getJenis_transaksi().equals("Utang")) {
                int nominal = Integer.parseInt(hutang.getNominal());
    ...
    static String countTotalUtangTeman(List<MUtangPiutang> dataList) {
        int totalPengeluaran = 0;
        for (MUtangPiutang hutang : dataList) {
            if (hutang.getJenis_transaksi().equals("Piutang")) {
                int nominal = Integer.parseInt(hutang.getNominal());
                totalPengeluaran += nominal;
            }
        }
        return DecimalsFormat.priceWithoutDecimal(String.valueOf(totalPengeluaran));
    }

    public static PdfPTable createDataTable(List<MUtangPiutang> dataList) throws DocumentException {
        ...
        PdfPCell cell;
        {
            ...
            cell = new PdfPCell(new Phrase("Dipinjam dari/Diutang ke", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(5f);
            table1.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase("Nominal Utang", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(5f);
            table1.addCell(cell);
        ...
        for (int i = 0; i < size; i++) {
            MUtangPiutang semua = dataList.get(i);
            ...
            cell = new PdfPCell(new Phrase(semua.getTgl_transaksi(), FONT_CELL));
            ...
            cell = new PdfPCell(new Phrase(semua.getDipinjamkan_ke(), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(7f);
            table1.addCell(cell);

            if (semua.getJenis_transaksi().equals("Utang")) {
                cell = new PdfPCell(new Phrase("Utang Saya", FONT_CELL));
            } else if (semua.getJenis_transaksi().equals("Piutang")) {
                cell = new PdfPCell(new Phrase("Utang teman", FONT_CELL));
            }
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(7f);
