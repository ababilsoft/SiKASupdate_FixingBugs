...
public final class exportSemuaPDF {
    ...
    public static void createPdf(@NonNull Context mContext, List<MCatatanKeuanganSemua> dataList, @NonNull String fileName, boolean isPortrait) throws Exception {
    ...
    public static void addHeader(Context mContext, Document document, List<MCatatanKeuanganSemua> dataList) throws Exception {
...

        {
            ...
            Paragraph temp = new Paragraph("Semua", FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph("Pemasukan", FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph("Rp. " + countTotalPemasukan(dataList), FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }
    ...
    static String countTotalPemasukan(List<MCatatanKeuanganSemua> dataList) {
        int totalPemasukan = 0;
        for (MCatatanKeuanganSemua semua : dataList) {
    ...
    static String countTotalPengeluaran(List<MCatatanKeuanganSemua> dataList) {
    ...
    public static PdfPTable createDataTable(List<MCatatanKeuanganSemua> dataList) throws DocumentException {
        PdfPTable table1 = new PdfPTable(6);
        table1.setWidthPercentage(100);
        table1.setWidths(new float[]{2f, 5f, 5f, 5f, 5f, 5f});
        ...
        PdfPCell cell;
        {
            ...
            cell = new PdfPCell(new Phrase("Tujuan / Diambil Dari", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(5f);
            table1.addCell(cell);
        ...
        for (int i = 0; i < size; i++) {
            MCatatanKeuanganSemua semua = dataList.get(i);
            ...
            if (semua.getJenisTransaksi().equals("pemasukan")) {
                cell = new PdfPCell(new Phrase(semua.getTujuanTabungan(), FONT_CELL));
            } else {
