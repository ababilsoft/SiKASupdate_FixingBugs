...
public class exportDetailRiwayatHutangPDF {
    ...
    public static void createPdf(@NonNull Context mContext, List<MHutangDetail> dataList, @NonNull String fileName, boolean isPortrait, String title, String targetDana, String statusUtang) throws Exception {
        ...
        addHeader(mContext, document, dataList, title, targetDana, statusUtang);
    ...
    public static void addHeader(Context mContext, Document document, List<MHutangDetail> dataList, String title, String targetDana, String statusUtang) throws Exception {
        ...
        PdfPCell cell;
        {
            ...
            Paragraph temp = new Paragraph("Keterangan", FONT_COLUMN);
...

        {
            ...
            Paragraph temp = new Paragraph(title, FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }
...

        {
            ...
            Paragraph temp = new Paragraph("Status Utang", FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph(statusUtang, FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph("Total Utang", FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }
...

        {
            ...
            Paragraph temp = new Paragraph("Utang Terbayar", FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }

        {
            ...
            Paragraph temp = new Paragraph("Rp. " + DecimalsFormat.priceWithoutDecimal(String.valueOf(countTotalDibayar(dataList))), FONT_COLUMN);
            temp.setAlignment(Element.ALIGN_LEFT);
            cell.addElement(temp);
            table.addCell(cell);
        }
    ...
    public static PdfPTable createDataTable(List<MHutangDetail> dataList) throws DocumentException {
        PdfPTable table1 = new PdfPTable(3);
        table1.setWidthPercentage(100);
        table1.setWidths(new float[]{2f, 5f, 5f,});
        ...
        PdfPCell cell;
        {
            ...
            cell = new PdfPCell(new Phrase("Nominal", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(5f);
            table1.addCell(cell);
        ...
        for (int i = 0; i < size; i++) {
            ...
            cell = new PdfPCell(new Phrase(semua.getNominal(), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(7f);
            table1.addCell(cell);
