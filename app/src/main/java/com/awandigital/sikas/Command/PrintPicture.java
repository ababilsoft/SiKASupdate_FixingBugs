package com.awandigital.sikas.Command;
...
public class PrintPicture {
	...
	public Bitmap addPaddingTopForBitmap(Bitmap bitmap, int paddingTop, int paddingBottom, int paddingRight, int paddingLeft) {
		...
		return addPaddingBottomForBitmap(outputBitmap, paddingBottom, paddingRight, paddingLeft);
	}


	public Bitmap addPaddingBottomForBitmap(Bitmap bitmap, int paddingBottom, int paddingRight, int paddingLeft) {
		Bitmap outputBitmap = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight() + paddingBottom, Bitmap.Config.ARGB_8888);
		Canvas canvas = new Canvas(outputBitmap);
		canvas.drawColor(Color.WHITE);
		canvas.drawBitmap(bitmap, 0, 0, null);
		return addPaddingRightForBitmap(outputBitmap, paddingRight, paddingLeft);
	}


	public Bitmap addPaddingRightForBitmap(Bitmap bitmap, int paddingRight, int paddingLeft) {
		Bitmap outputBitmap = Bitmap.createBitmap(bitmap.getWidth() + paddingRight, bitmap.getHeight(), Bitmap.Config.ARGB_8888);
		Canvas canvas = new Canvas(outputBitmap);
		canvas.drawColor(Color.WHITE);
		canvas.drawBitmap(bitmap, 0, 0, null);
		return addPaddingLeftForBitmap(outputBitmap, paddingLeft);
	}
